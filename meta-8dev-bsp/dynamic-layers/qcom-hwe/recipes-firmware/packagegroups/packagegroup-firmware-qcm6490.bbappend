...
# subsystems - DSP PAS images, Adreno, audio, compute, VPU, WCN6750/ath11k
# Wi-Fi (we use external QCN9274 over ath12k). KEPT: qupv3fw (GENI serial-engine
# firmware for our I2C/UARTs) and verinfo.
#
