# libcamera 0.7.1 (mirrored from OE master) for citron: scarthgap meta-multimedia
# ships 0.4.0, which lacks the colour-temperature AWB + CCM soft ISP the IMX577
# pipeline needs. DEFAULT_PREFERENCE="-1" keeps 0.4.0 the default; citron opts in
# via PREFERRED_VERSION_libcamera in citron.inc, leaving tobufi on 0.4.0.
...
# scarthgap's fetcher rejects tag=+SRCREV together; pin by SRCREV (v0.7.1 commit).
SRC_URI = " \
